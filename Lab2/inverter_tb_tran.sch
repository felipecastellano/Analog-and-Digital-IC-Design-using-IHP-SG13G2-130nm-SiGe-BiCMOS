...
C {vsource.sym} -1040 -290 0 0 {name=V2 value=1.5 savecurrent=false}
C {vsource.sym} -960 -290 0 0 {name=Vin value="PULSE(0 1.5 0 5n 5n 1u 2u)" savecurrent=false}
